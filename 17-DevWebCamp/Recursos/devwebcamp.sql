...
CREATE TABLE `registros` (
  ...
  KEY `registros_ibfk_3` (`regalo_id`),
  ...
  CONSTRAINT `registros_ibfk_3` FOREIGN KEY (`regalo_id`) REFERENCES `regalos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `registros` VALUES (4,1,'69183833MV4978634','b097b495',2,NULL),(5,1,'9AE98688BW6862937','bac5c398',2,NULL),(6,1,'5DB77734FJ4401323','88c4c3ae',2,NULL);
...
INSERT INTO `usuarios` VALUES (1,'José Miguel','Izquierdo','correo@correo.com','$2y$10$Vltv3RWzb78pbJPKePIvEu7ZZtsGGgEIG3/2BruPsBOa.epNLv78C',1,'',1),(2,'Paco','Porras','paco@paco.com','$2y$10$a8XQ0DYqAo55nL9q03W0sOjc5XBNKUzc/WyZlkUXqTIP9JNgHaaOm',1,'',0);
...
-- Dump completed on 2023-07-24 22:44:09
